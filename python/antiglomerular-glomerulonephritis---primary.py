...
codes = [{"code":"K014.00","system":"readv2"},{"code":"K015.00","system":"readv2"},{"code":"K0A..00","system":"readv2"},{"code":"K0A0000","system":"readv2"},{"code":"K0A0100","system":"readv2"},{"code":"K0A2000","system":"readv2"},{"code":"K0A2100","system":"readv2"}];
REQUIRED_CODES = 1;
